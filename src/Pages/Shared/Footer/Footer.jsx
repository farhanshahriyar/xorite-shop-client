  ...
  <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        >
        Xorite Shop is a bike repairing shop where people can fix their bike and buy bike parts.
        </p>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span className="text-gray-700">farhan@Xorite.com</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="text-gray-700">01989449877</span>
              </a>
            </li>
            ...
            >
              ...
              <address className="-mt-0.5 not-italic text-gray-700">
                213 Lane, East Basaboo, Dhaka-1214, Bangladesh
              </address>
            </li>
          </ul>
        </div>
